...
<div id="middleopacity"><div class="divv" align="center"> </div><h1 align="right"><center>Malaysia's first Vegan Malay Food</center> </h1></div>
  <br/>
  <br/><br/>
  <br/><br/>
  <br/>
...
<div id="foodopacityboxx" class="containerr" >
<img id="food"   src="Pictures/Screenshot_6.png" alt="Screenshot_6" width="180" height="180">
<img id="foodd"  src="Pictures/Screenshot_5.png" alt="Screenshot_5" width="180" height="180">
<img id="fooddd"  src="Pictures/Screenshot_12.png" alt="Screenshot_12" width="180" height="180">
  <div class="overlay">
    <div class="text">Sneak peak of our menu</br>Coming Soon AUGUST 2018</div>
</div></div>

</br>
</br>

<div id="foodopacitybox" class="containerr" >
<h1 id="Eventtext">Event</h1><p id="Eventtext">example</p>
<div class="overlay">
<div class="text">Hilmi can you think of ideas to fit in here.</div>

</div><img src="Pictures/pexels-photo-126590.jpg" id="Eventpicture"></div>
</br>
</br>
<div id="foodopacitybox" class="containerr" >
<h1 id="Eventtext">Promotions</h1><p id="Eventtext">example</p>
<div class="overlay">
<div class="text">Hilmi can you think of ideas to fit in here.</div>
